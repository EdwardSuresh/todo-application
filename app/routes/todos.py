...
@router.post("", response_model=TodoResponse) # /todos  
...
@router.put("/{todo_id}", response_model=TodoResponse) # /todos/{todo_id}
...
@router.delete("/{todo_id}", response_model=TodoResponse) # /todos/{todo_id}
